    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-32 lg:pt-32 lg:pb-40">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
          ...
          <div className="absolute bottom-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full bg-blue-50 blur-[120px] opacity-60 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
      </section>
          ...
          <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-12 shadow-2xl overflow-hidden relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
              <div>
                ...
                <div className="text-indigo-300 font-medium">Akurasi Analisis</div>
              </div>
              <div>
                <div className="text-4xl md:text-5xl font-black text-white mb-2">10k+</div>
                <div className="text-indigo-300 font-medium">Lowongan Kerja</div>
              </div>
              <div>
                <div className="text-4xl md:text-5xl font-black text-white mb-2">&lt; 3s</div>
                <div className="text-indigo-300 font-medium">Waktu Rekomendasi</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">Bagaimana Cara Kerjanya?</h2>
            <p className="text-gray-500 max-w-xl mx-auto">Tiga langkah mudah untuk mendapatkan pekerjaan yang benar-benar cocok dengan kualifikasi Anda.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-10 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-indigo-100/50 transition-all duration-300 group"
              >
                <div className={`w-16 h-16 flex items-center justify-center rounded-2xl bg-gradient-to-br ${step.gradient} shadow-lg mb-8 group-hover:scale-110 transition-transform duration-300`}>
                  {step.icon}
                </div>
